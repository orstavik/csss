...
//$font(Cantarell:i:slnt-5:660,Droid+Serif:700:slnt-4:i,Roboto,uppercase)
//$font(Cantarell:i:slnt-5:660,Droid+Serif:700,Roboto:600:wdth95%:hght:102%,uppercase)

// => we add both the native and the variation settings for all types.
// This must be done in the umbrella and the droplets.
...
//$font("Company Font",grotesque,condensed,italic,-10deg,uppercase,spacing(-3),700)


//<style rules:extract-unknown-fonts:add-bunny.net-import:rules>
...
export const WORDS = {
  font: {
    Family: {
      ...
      mono: 'ui-monospace, Menlo, Consolas, "Liberation Mono", "Courier New", monospace, sans-serif, "Roboto Mono", system-ui, Ubuntu, Ubuntu Mono',
      serif: 'ui-serif, Georgia, Cambria, "Noto Serif", serif',
      cursive: 'ui-rounded, "Comic Sans MS", "Apple Chancery", "Brush Script MT", cursive',
      fantasy: 'ui-fantasy, Impact, "Comic Sans MS", "Arial Rounded MT Bold", fantasy',
      emoji: 'ui-emoji, "Segoe UI Emoji", "Apple Color Emoji", "Noto Color Emoji", "Twemoji", emoji',
      math: 'ui-math, "Noto Sans Math", "STIX Two Math", "Cambria Math", math',
      fangsong: 'ui-fangsong, "STFangsong", "Songti SC", "Songti TC", fangsong',
      ui: 'ui, "Segoe UI", "Helvetica Neue", "Arial", sans-serif',
