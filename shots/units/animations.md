**description:**
An element that animates translate y from -20px to 20px in infinite alternate loop.
**csss:**
```csss
...
```
**description:**
An element that animates translate x from 0px to 100px over 2000 milliseconds.
**csss:**
```csss
...
```
**description:**
An element that animates opacity from 1 down to 0.3 over 3 seconds.
**csss:**
```csss
...
```
**description:**
An element that animates scale from 1 up to 1.5 over 4000 milliseconds.
**csss:**
```csss
...
```
**description:**
An element that animates rotation from 0deg to 180deg over 5 seconds.
**csss:**
```csss
...
```
**description:**
An example demonstrating runs three simultaneous animations: fade in, scale up and slide up.
**csss:**
```csss
...
```
**description:**
An element that animates translate x from 0px+1px to 30px*2 over 2 seconds.
**csss:**
```csss
...
```
**description:**
An element that animates translate y while leaving x unchanged.
**csss:**
```csss
