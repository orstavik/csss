...
@layer containerDefault {
  .\$transition\(bounceInOut\,2s\,margin\,color\) {
    ...
    transition: margin 2s var(--t), color 2s var(--t);
  }
}
```
...
@layer containerDefault {
  .\$transition\(backInOut\,1s\,1s\,transform\,opacity\) {
    --t: linear(0,.007,.02,.036,.052,.063,.067,.061,.043,.016,-.018,-.054,-.088,-.114,-.129,-.129,-.114,-.085,-.045,0,.053,.105,.158,.211,.263,.316,.368,.421,.474,.526,.579,.632,.684,.737,.789,.842,.895,.947,1,1.045,1.085,1.114,1.129,1.129,1.114,1.088,1.054,1.018,.984,.957,.939,.933,.937,.948,.964,.98,.993,1);
    transition: transform 1s 1s var(--t), opacity 1s 1s var(--t);
  }
}
```
